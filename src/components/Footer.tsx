      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold">Poha Manufacturing</span>
              </div>
              <p className="text-gray-400 max-w-md">
                Professional financial analysis and business intelligence platform for manufacturing operations. 
        ...
        >
          <p className="text-gray-400 text-sm">
            © {currentYear} Poha Manufacturing Dashboard. All rights reserved.
          </p>
